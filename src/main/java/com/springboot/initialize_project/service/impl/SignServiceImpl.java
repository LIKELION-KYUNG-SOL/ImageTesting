...
public class SignServiceImpl implements SignService {
    ...
    public KakaoUserRepository kakaoUserRepository;
    ...
    @Override
    public void signUpUsingDto(SignUpDto signUpDto) {
        LOGGER.info("[signUp] 회원가입정보를 전달하였습니다.");

        if(signUpDto.getIsKakao()){
            ...
            user = User.builder()
                    ...
                    .roles(Collections.singletonList(signUpDto.getRole()))
                    .carat(Long.valueOf(0))
                    .status(true)
                    .is_kakao(true)
                    .build();
            ...
            KakaoUser kuser = KakaoUser.builder()
                    			.kakaoEmail(signUpDto.getAccount())
                    			.build();
            KakaoUser savedKakaoUser = kakaoUserRepository.save(kuser);
        }else{
            User user;
